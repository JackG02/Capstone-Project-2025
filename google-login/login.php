...
<head>
    ...
    <style>
        ...
        /* Make content and coursera containers responsive */
...
<body class="rvt-layout">
        ...
        <div class="rvt-header-global">
            <div class="rvt-container-lg">
                <div class="rvt-header-global__inner">
                    <!-- IU Logo and Site Name -->
                    <a class="rvt-lockup" href="../google-login/profile.php">
    ...
    <main id="main-content" class="rvt-layout__wrapper">
        <div class="rvt-container-lg rvt-p-tb-xl">
            <div class="rvt-card rvt-card--raised rvt-p-all-lg">
                <div class="content-container">
                    <div>
                        <h1 class="rvt-ts-32 rvt-text-bold">Welcome to PathFinder!</h1>
                        <p class="rvt-ts-18 rvt-p-top-sm">
                            We invite you to explore PathFinder and take advantage of its features to enhance your academic journey. Whether you’re looking to choose a minor or track your progress, our system offers personalized recommendations and easy-to-follow paths to help you succeed.
                        </p>
                        <!-- Bootstrap Login Form -->
                        <div class="login-container">
                            <form action="google-oauth.php" method="POST" style="display:inline;">
                                <input type="hidden" name="role" value="student">
                                <button type="submit" class="rvt-button rvt-button--primary rvt-m-right-sm">Login as Student</button>
                            </form>
                            <form action="google-oauth.php" method="POST" style="display:inline;">
                                <input type="hidden" name="role" value="advisor">
                                <button type="submit" class="rvt-button rvt-button--primary">Login as Advisor</button>
                            </form>
                        </div>


                    </div>
                    <img src="../images/IULogo.jpg" alt="PathFinder Preview">
                </div>
            </div>
        </div>
        ...
        <div class="rvt-container-lg rvt-p-tb-xl">
            <div class="rvt-card rvt-card--raised rvt-p-all-lg">
                <div class="coursera-container">
                    <img src="../images/coursera.png" alt="Coursera Preview">
                    <div>
                        <h1 class="rvt-ts-32 rvt-text-bold">Explore Minors with Coursera</h1>
                        <p class="rvt-ts-18 rvt-p-top-sm">
                            PathFinder partners with Coursera to help you explore different academic minors before making a decision. Coursera offers online courses in a wide range of subjects, allowing you to experience coursework in potential minors before fully committing.
                        </p>
                        <p class="rvt-ts-18 rvt-p-top-sm">
                            Whether you're considering a minor in Computer Science, Psychology, Business, or another field, Coursera provides introductory courses that give you hands-on experience and insights into the subject. This way, you can determine if the minor aligns with your interests and career goals.
                        </p>
                        <a href="https://about.coursera.org/" target="_blank" class="rvt-button rvt-button--primary rvt-m-top-md">
                            Explore Coursera
                        </a>
                    </div>
                </div>
